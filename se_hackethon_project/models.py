from se_hackethon_project import db,login_manager,app
...
class User(db.Model,UserMixin):
    ...
    analyzeSessions = db.relationship('Accuracy',backref='results',lazy=True)
...
class Accuracy(db.Model):
    ...
    def __repr__(self):
        return f"Post('{self.id}','{self.date_posted}','{self.user_id}')"
